            ...
            if (location_switch.isChecked()){
                ...
                geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(), new GeoLocation(latitude, longitude), new  GeoFire.CompletionListener() {
                    ...
                    public void onComplete(String key, DatabaseError error) {
                        ...
                        if (mCurrent != null){
                            mCurrent.remove(); //menghilangkan marker yang sebelumnya
                        }

                        //menggunakan mobil sebagai ikon dan menaruhnya ke latitude dan longitude yang sekarang
                        ...
                        //memindahkan kamera ke posisi ini
                        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(latitude,longitude), 15.0f));
                        
                        //menggambar animasi rotasi marker
